...
<img src="asset/多分类问题0.png" style="zoom:50%;" />



softmax激活函数的使用使得每一个概率值都大于0， 且总的概率和为1

注：激活即进行非线性变换

<img src="asset/多分类问题0_1.png" style="zoom:50%;" />

<img src="asset/多分类问题1.png" style="zoom:50%;" />

## 交叉熵损失函数

<img src="asset/多分类问题2.png" style="zoom:50%;" />

<img src="asset/多分类问题3.png" style="zoom:50%;" />
...
图像的表示： W x H x C (W：宽度， H：高度，C(channel)：通道数)

① 灰度图：为单通道图像

②彩色图像：一般为R G B三通道图像 

一般神经网络的输入值为0-1之间，符合正态分布，这样取得的效果最好
...
<img src="asset/多分类问题4.png" style="zoom:50%;" />
